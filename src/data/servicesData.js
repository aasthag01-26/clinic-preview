...
const servicesData = {
    ...
    
    {
      ...
      services: [
        ...
        },
        {
          ...
          image: "/lhr/upperlowerfacelhr.webp",
          details: {
            about:
        ...
        },
        {
          ...
          image: "/lhr/upperlipchinlhr.jpeg",
          details: {
            about:
  ...
  about:
    "Customized facials designed to treat acne, boost hydration, brighten dull skin, and restore youthful elasticity. Each treatment is tailored to your unique skin concerns, delivering visible results and a healthy glow without downtime.",
  services: [
    {
      id: "facial-derma-revive",
      name: "Derma Revive Facial",
      tagline: "Revive tired skin with deep hydration.",
      image: "/facial/dermarevivefacial.jpeg",
      description: "Multi-step facial to deeply hydrate & restore glow.",
      details: {
        about:
          "A luxurious treatment that restores deep hydration while strengthening the skin barrier. Perfect for reviving dull, fatigued skin—leaving it plump, supple, and radiant.",
        perfectFor: [
        ...
        beforeCare: [
          "Avoid retinoids or exfoliants 3 days prior",
          "Stay well-hydrated",
        ],
        afterCare: [
          "Use gentle cleansers for 24 hrs",
          "Apply sunscreen daily",
          "Continue hydrating serums",
        ],
        faqs: [
          { q: "How often should I get this?", a: "Every 3–4 weeks for lasting results." },
    ...
    },
    {
      ...
      image: "/facial/koreanglowfacial.jpeg",
      description: "Brightens skin and reduces pigmentation for a glass-skin finish.",
      details: {
        about:
          "A Korean-inspired multi-step facial that hydrates, brightens, and refines texture for a luminous glass-skin glow.",
        perfectFor: ["Uneven skin tone", "Pigmentation", "Dull complexion", "Texture improvement"],
        steps: [
        ...
        beforeCare: [
          ...
          "Pause harsh actives (retinoids, AHAs/BHAs)",
        ],
        afterCare: [
          "Avoid direct sun for 24 hrs",
          "Moisturize & apply SPF daily",
        ],
        faqs: [
          { q: "Safe for sensitive skin?", a: "Yes, customizable for sensitivity." },
          { q: "How many sessions for best results?", a: "3–4 sessions recommended for lasting glow." },
        ],
        duration: "70–90 mins",
      },
    },
    {
      ...
      image: "/facial/acnearrestorfacial.jpeg",
      description: "Reduces acne, unclogs pores & soothes irritation.",
      details: {
        about:
          "Designed for acne-prone skin, this treatment clears clogged pores, reduces active breakouts, and calms redness for a clearer complexion.",
        perfectFor: ["Active acne", "Oily/congested skin", "Blackheads & whiteheads", "Post-inflammatory redness"],
        steps: [
          "Deep pore cleanse",
          "Gentle exfoliation",
          "Acne-safe actives",
        ...
        beforeCare: [
          "Avoid heavy acne creams 48 hrs prior",
          "Do not pick or irritate active acne",
        ],
        afterCare: [
        ...
        faqs: [
          ...
          { q: "Is it safe for teens?", a: "Yes, effective for teenagers." },
        ],
        duration: "50–70 mins",
      },
    },
    {
      ...
      image: "/facial/quickfixfacial.jpeg",
      description: "Fast brightening treatment for pre-events.",
      details: {
        about:
          "An express 30–40 minute treatment that delivers an instant glow—perfect before events, weddings, or parties.",
        perfectFor: ["Event-ready skin", "Last-minute glow", "Pre-wedding prep", "Busy professionals"],
        steps: ["Gentle cleanse", "Exfoliation", "Brightening mask", "Hydration + SPF"],
        beforeCare: ["No special preparation required"],
        afterCare: ["Hydrate & avoid heavy makeup for 6–8 hrs"],
        faqs: [{ q: "How long does the glow last?", a: "3–7 days depending on skincare routine." }],
        duration: "30–40 mins",
      },
    },
    {
      ...
      image: "/facial/instacolleganfacial.jpeg",
      description: "Stimulates collagen to improve elasticity & reduce fine lines.",
      details: {
        about:
          "A rejuvenating treatment that stimulates collagen production, reduces fine lines, and improves elasticity for a youthful glow.",
        perfectFor: ["Fine lines", "Loss of firmness", "Early signs of aging", "Skin fatigue"],
        steps: ["Deep cleanse", "Collagen serum infusion", "Massage therapy", "Firming mask", "SPF application"],
        beforeCare: ["Avoid retinoids 48 hrs prior"],
        afterCare: ["Hydrate & apply SPF daily"],
        faqs: [
          { q: "Are results immediate?", a: "Yes, skin looks plumper instantly; long-term results with regular sessions." },
        ],
        duration: "50–70 mins",
      },
    },
    {
      ...
      image: "/facial/hydrafacial.jpeg",
      description: "Replenishes skin moisture and repairs barrier.",
      details: {
        about:
          "A hydration-focused treatment that restores moisture, soothes sensitivity, and leaves skin fresh and supple.",
        perfectFor: ["Dehydrated skin", "Post-sun exposure", "Flaky/rough texture", "Sensitive skin"],
        steps: ["Hydrating cleanse", "Serum infusion", "Moisture-lock mask", "Calming finish"],
        beforeCare: ["Avoid exfoliation 3 days prior"],
        afterCare: ["Maintain hydration with serums & moisturizers"],
        faqs: [
          { q: "Does it make skin oily?", a: "No, only water-based hydrators are used—safe for oily skin." },
        ],
        duration: "45–60 mins",
      },
    },
    {
      ...
      image: "/facial/doubledharmaboost.jpeg",
      description: "Combines exfoliation + infusion for advanced glow.",
      details: {
        about:
          "An advanced dual-step facial combining exfoliation with nutrient infusion to brighten and energize skin.",
        perfectFor: ["Pigmentation", "Texture irregularities", "Tired skin", "Uneven tone"],
        steps: ["Skin exfoliation", "Nutrient-rich infusion", "Moisturizing mask"],
        beforeCare: ["Avoid strong actives 72 hrs prior"],
        afterCare: ["Daily SPF is essential to maintain results"],
        faqs: [{ q: "Any downtime?", a: "No, mild redness may occur for a few hours." }],
        duration: "60–80 mins",
      },
    },
    {
      ...
      image: "/facial/elastinboostfacial.jpeg",
      description: "Firming treatment to fight sagging & loss of elasticity.",
      details: {
        about:
          "A peptide-powered facial that restores firmness, improves elasticity, and visibly lifts sagging skin.",
        perfectFor: ["Loss of firmness", "Sagging skin", "Mature skin", "Post-weight loss skin"],
        steps: ["Deep cleanse", "Peptide infusion", "Firming massage", "Tightening mask"],
        beforeCare: ["Avoid strong peels 2 weeks prior"],
        afterCare: ["Maintain results with peptide serums + SPF"],
        faqs: [{ q: "How many sessions needed?", a: "3–6 sessions recommended for best results." }],
        duration: "50–70 mins",
      },
    },
    {
      ...
      image: "/facial/couplefacial.jpeg",
      description: "A relaxing laser facial designed for two.",
      details: {
        about:
          "A premium laser facial for two—enjoy rejuvenation together while achieving radiant skin.",
        perfectFor: ["Couples", "Friends pre-event", "Special occasions", "Pampering experience"],
        steps: ["Consultation", "Customized laser rejuvenation", "Soothing mask + hydration"],
        beforeCare: ["Avoid tanning for 2 weeks prior"],
        afterCare: ["Hydrate & apply SPF daily"],
        faqs: [{ q: "Will both get same results?", a: "Yes, treatments are customized individually." }],
        duration: "60–90 mins",
      },
    },
  ],
  ...
  "services": [
    {
      ...
      "image": "/slimming/faceslimming.webp",
    ...
    },
    {
      ...
      "image": "/slimming/abdomenslimming.jpeg",
      ...
      "details": {
        ...
        "beforeCare": ["Avoid heavy meals 2 hours before session", "Avoid alcohol 24 hours prior"],
        ...
        "faqs": [
          ...
          { "q": "Will results last?", "a": "Yes, when combined with a healthy diet & lifestyle." }
        ],
        "duration": "45–60 mins"
      }
    },
    {
      ...
      "image": "/slimming/arminchloss.jpeg",
      ...
      "details": {
        ...
        "beforeCare": ["Avoid strenuous exercise before session"],
    ...
    },
    {
      ...
      "image": "/slimming/hipinchloss.jpeg",
      ...
      "details": {
        ...
        "beforeCare": ["Avoid alcohol or heavy meals before session"],
        "afterCare": ["Stay well hydrated", "Avoid intense exercise for 24 hrs"],
        "faqs": [
    ...
    },
    {
      ...
      "image": "/slimming/thighinchloss.jpeg",
    ...
    },
    {
      ...
      "image": "/slimming/lovehandle.jpeg",
      ...
      "details": {
        ...
        "beforeCare": ["Avoid heavy meals 2 hours before session"],
        "afterCare": ["Stay hydrated", "Light stretching or walking helps circulation"],
        "faqs": [
    ...
    },
    {
      ...
      "image": "/slimming/upperbodyinchloss.jpeg",
    ...
    },
    {
      ...
      "image": "/slimming/fatburninjection.jpg",
    ...
    services: [
      {
        ...
        image: "/skin/fullbodychemicalpeel.jpeg",
        ...
        details: {
          ...
          variants: ["Carbon Peel", "Lactic Peel", "Glycolic Peel"]
        }
      },
      {
      ...
      },
      {
        ...
        image: "/skin/underarmsdetan.jpeg",
  ...
  "services": [
    {
      ...
      "image": "/chemicalpeel/glycolic.jpeg",
    ...
    },
    {
      ...
      "image": "/chemicalpeel/salicilic.jpeg",
      ...
      "details": {
        ...
        "faqs": [
          { "q": "Will it purge skin?", "a": "Some purging may occur initially." }
        ],
        "duration": "20–30 mins"
      }
    },
    {
      ...
      "image": "/chemicalpeel/mendalic.jpeg",
      ...
      "details": {
        ...
        "faqs": [
          { "q": "Safe?", "a": "Yes, when performed by trained professional." }
        ],
        "duration": "15–25 mins"
      }
    },
    {
      ...
      "image": "/chemicalpeel/monkeymouth.jpeg",
      ...
      "details": {
        ...
        "faqs": [
          { "q": "Number of sessions?", "a": "3–4 sessions for best results." }
        ],
        "duration": "15–30 mins"
      }
    },
    {
      ...
      "image": "/chemicalpeel/lacticpeel.jpeg",
      ...
      "details": {
        ...
        "faqs": [
          { "q": "Good for sensitive skin?", "a": "Yes, at lower strengths." }
        ],
        "duration": "20–30 mins"
      }
    },
    {
      ...
      "image": "/chemicalpeel/yellowpeel.jpeg",
      ...
      "details": {
        ...
        "faqs": [
          { "q": "Downtime?", "a": "Some peeling for several days possible." }
        ],
        "duration": "30–40 mins"
      },
    },
  ...
  "services": [
    {
      ...
      "image": "/injeactible/faceprp.jpeg",
    ...
    },
    {
      ...
      "image": "/injeactible/facegfc.jpeg",
      ...
      "details": {
        ...
        "faqs": [
          { "q": "How soon results?", "a": "Gradual improvement in weeks." }
        ],
        "duration": "45–60 mins"
      }
    },
    {
      ...
      "image": "/injeactible/glutathione600mg.jpeg",
      ...
      "details": {
        ...
        "faqs": [
          { "q": "Any side effects?", "a": "Rare nausea or lightheadedness." }
        ],
        "duration": "30–45 mins"
      }
    },
    {
      ...
      "image": "/injeactible/glutathione1800mg.jpeg",
